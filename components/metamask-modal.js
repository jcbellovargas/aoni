    ...
    <>
      ...
      <div className="modal">
        <div className="modal-box relative">
          ...
          <h3 className="text-lg font-bold">Esta aplicacion requiere Metamask para funcionar.</h3>
          <p className="py-4">Podes descargarlo en
            <a className="text-primary" href="https://metamask.io/download/" target="blank"> este link</a>
          </p>
        </div>
      </div>
    </>
